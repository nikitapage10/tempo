...
export function GlobalPlayerBar() {
  ...
  return (
    <div className="px-1.5 pb-3 lg:px-3">
      ...
      >
        <span className="relative size-11 shrink-0 overflow-hidden rounded-input border border-line shadow-e1 lg:size-28">
          <SpectraCoverArt
            trackId={current.id}
            title={current.title}
      ...
      <div className="mt-2 flex flex-col items-center gap-2 lg:mt-2.5 lg:flex-row lg:justify-center lg:gap-4">
        <button
          type="button"
          aria-label="Previous track"
          onClick={prev}
          className="hidden text-text-lo transition-colors duration-hover hover:text-text-hi focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ice lg:inline-flex"
        >
        ...
        <button
          ...
          onClick={toggle}
          disabled={loading}
          className="flex size-9 items-center justify-center rounded-full bg-ice text-bg-0 transition-opacity duration-hover hover:opacity-90 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ice lg:size-8"
        >
          {playing ? (
