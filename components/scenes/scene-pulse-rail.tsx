    ...
    <aside className="space-y-3 lg:sticky lg:top-6 lg:self-start">
      <div className="panel-quiet overflow-hidden p-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <div className="rounded-input border border-line bg-bg-1 p-3"><p className="font-display text-xl font-semibold text-text-hi">{analytics?.active_members ?? scene.member_count}</p><p className="mt-1 text-[11px] text-text-lo">active members</p></div>
          <div className="rounded-input border border-line bg-bg-1 p-3"><p className="font-display text-xl font-semibold text-text-hi">{analytics?.posts ?? 0}</p><p className="mt-1 text-[11px] text-text-lo">posts this month</p></div>
        </div>
      </div>
