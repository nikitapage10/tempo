...
- Today (/): greeting, quick actions, and — in a music space — due tasks, up to five needs-attention items with Show more, and a drifting cover strip; in a tasks-focused space — open tasks and project progress instead.
...
- Calendar (/calendar): month, agenda, and creative timeline across tasks, track dates, projects, releases, pitching, and standalone events. Each type has a distinct default color; Categories renames/recolors types and adds custom event categories after migration 075.
