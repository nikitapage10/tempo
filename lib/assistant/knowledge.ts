...
- Tasks (/tasks): Overdue / Today / This week / Later columns, scoped to the active space. Drag a task between columns to change its due date (Today sets today; This week / Later / Overdue asks which day). Completed work lives under Closed out, not under the board.
