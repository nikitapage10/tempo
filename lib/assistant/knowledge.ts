...
WHERE THINGS LIVE
- First workspace open: after Origin, an optional five-step tour spotlights Today, quick actions, navigation, global search, and the assistant. It can be skipped before or during the tour and is remembered per artist. Settings → Replay introduction deliberately replays both the Origin film and the tour.
